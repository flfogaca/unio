...
export const SpecialtiesDashboard: React.FC<SpecialtiesDashboardProps> = ({
  onSelectSpecialty,
}) => {
  ...
  const defaultSpecialties: Specialty[] = [
    {
      ...
      name: 'Psicólogo',
      description:
        'Atendimento psicológico com opções de consulta urgente ou agendada',
      icon: 'brain',
      color: '#8B5CF6',
      features: [
  ...
  const getOverallStats = () => {
    ...
    const totalOnline = specialties.reduce(
      (sum, s) => sum + s.onlineProfessionals,
      0
    );
    const totalInProgress = specialties.reduce(
        ...
        <div className='mt-12 text-center'>
          <Card className='p-6 bg-blue-50 border-blue-200'>
            ...
            <p className='text-blue-700'>
              Nossa plataforma está disponível 24 horas por dia, 7 dias por
              semana. Profissionais estão sempre disponíveis para atendê-lo.
            </p>
          </Card>
        </div>
      </div>
