...
export const PatientMedicalHistory: React.FC<PatientMedicalHistoryProps> = ({
    ...
    try {
      ...
      const mockRecords: MedicalRecord[] = [
        ...
        },
        {
          ...
          notes:
            'Paciente apresentou cárie no dente 16. Realizada restauração com resina composta.',
          vitalSigns: {
        ...
        },
        {
          ...
          notes:
            'Paciente diagnosticado com hipertensão arterial. Iniciado tratamento com Losartana.',
          vitalSigns: {
  ...
  const filteredRecords = records.filter(record => {
    ...
    const matchesSpecialty =
      selectedSpecialty === 'all' || record.specialty === selectedSpecialty;
                    ...
                    <div className='flex items-center gap-3 mb-2'>
                      ...
                      <div>
                        <h3 className='font-semibold text-gray-900'>
                          {
                            specialtyNames[
                              record.specialty as keyof typeof specialtyNames
                            ]
                          }
                        </h3>
                        <p className='text-sm text-gray-500'>
