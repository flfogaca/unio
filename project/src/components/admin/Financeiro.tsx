...
export function Financeiro({ onBack }: FinanceiroProps) {
  ...
  const dadosFinanceiros = {
    resumo: {
      receitaTotal: 187350.0,
      receitaMes: 45280.0,
      crescimentoMensal: 12.5,
      consultasFinalizadas: 1189,
      ticketMedio: 157.5,
      receitaPorDentista: 15612.5,
      margemLucro: 68.5,
      custoOperacional: 58920.0,
    },
    transacoes: [
      {
        id: 'TXN001',
              ...
              <CardContent className='p-6'>
                <div className='flex items-center justify-between'>
                  <div className='flex-1'>
                    ...
                    <p className='text-2xl font-bold text-primaryDark mt-1'>
                      {kpi.valor}
                    </p>
                  ...
                  <div
                    className={`w-12 h-12 ${kpi.cor} rounded-lg flex items-center justify-center ml-4`}
                  >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <Card>
          ...
          <CardContent>
            <div className='h-80'>
              <Line
                data={dadosFinanceiros.receitaMensal}
        ...
        <Card>
          ...
          <CardContent>
            <div className='h-80'>
              <Doughnut
                data={dadosFinanceiros.receitaPorEspecialidade}
                options={chartOptions}
              />
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className='h-64 mb-4'>
              <Doughnut
                data={dadosFinanceiros.metodosPagamento}
                options={chartOptions}
              />
            </div>
              ...
              <div className='flex items-start gap-3 p-3 bg-green-50 border border-green-200 rounded-lg'>
                ...
                <div>
                  ...
                  <p className='text-sm text-green-700'>
                    Receita de janeiro superou a meta em 8.2% (R$ 3.420 acima do
                    esperado)
                  </p>
                </div>
              </div>
                ...
                {dadosFinanceiros.transacoes.map(transacao => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className='p-4'>
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(transacao.status)}`}
                        >
                      ...
                      <td className='p-4'>
                        <div className='text-sm'>
                          ...
                          <p className='text-gray-500'>
                            {transacao.data.toLocaleTimeString('pt-BR', {
                              hour: '2-digit',
                              minute: '2-digit',
                            })}
                          </p>
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'configuracoes':
        return (
          <div className='text-center py-12 text-gray-500'>
            Configurações financeiras em desenvolvimento
          </div>
        );
      default:
        return renderVisaoGeralTab();
          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-4'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Status: Operacional • Última sincronização:{' '}
