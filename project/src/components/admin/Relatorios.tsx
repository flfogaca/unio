            ...
            <Card key={kpi.titulo}>
              <CardContent className='p-6'>
                <div className='flex items-center justify-between'>
                  ...
                  <div
                    className={`w-12 h-12 ${kpi.cor} rounded-lg flex items-center justify-center`}
                  >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <Card>
          ...
          <CardContent>
            <div className='h-64'>
              <Bar
                data={relatoriosData.consultasPorDia}
        ...
        <Card>
          ...
          <CardContent>
            <div className='h-64'>
              <Doughnut
                data={relatoriosData.especialidades}
                options={chartOptions}
              />
            </div>
          </CardContent>
            ...
            <div className='flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  As consultas aumentaram 12% em relação ao mês anterior, com
                  destaque para Ortodontia (+25%).
                </p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700'>
                  O tempo médio de espera diminuiu 5 minutos após as últimas
                  otimizações na fila.
                </p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-yellow-700'>
                  Quinta-feira apresenta maior volume de consultas. Considere
                  ajustar a equipe.
                </p>
              </div>
            </div>
                    ...
                    <td className='p-3'>
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${
                          dentista.status === 'online'
                            ? 'bg-green-100 text-green-800'
                            : dentista.status === 'ocupado'
                              ? 'bg-yellow-100 text-yellow-800'
                              : 'bg-gray-100 text-gray-800'
                        }`}
                      >
                        {dentista.status.charAt(0).toUpperCase() +
                          dentista.status.slice(1)}
                      </span>
                    </td>
                  </tr>
                ))}
              ...
              {[
                ...
                >
                  <div className='flex items-center gap-3'>
                    <div
                      className={`w-3 h-3 ${periodo.cor} rounded-full`}
                    ></div>
            ...
            <CardContent className='p-6'>
              <div className='flex items-start justify-between mb-4'>
                <div className='flex-1'>
                  <h3 className='font-semibold text-primaryDark mb-2'>
                    {relatorio.titulo}
                  </h3>
                  ...
                  <div className='text-xs text-gray-500 space-y-1'>
                    ...
                    <p>
                      Tamanho: {relatorio.tamanho} • {relatorio.downloads}{' '}
                      downloads
                    </p>
                  </div>
                </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className='flex justify-end gap-3 mt-6'>
            <Button variant='secondary'>Salvar como Template</Button>
            <Button>
      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-4'>
            {[
              {
                nome: 'Relatório Semanal de Operações',
                frequencia: 'Toda segunda-feira',
                proximo: '25/01/2024',
                ativo: true,
              },
              {
                nome: 'Análise Mensal Financeira',
                frequencia: 'Todo dia 1º do mês',
                proximo: '01/02/2024',
                ativo: true,
              },
              {
                nome: 'Satisfação Trimestral',
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'qualidade':
        return (
          <div className='text-center py-12 text-gray-500'>
            Relatórios de qualidade em desenvolvimento
          </div>
        );
      case 'customizados':
