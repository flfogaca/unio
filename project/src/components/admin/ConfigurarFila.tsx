...
export function ConfigurarFila({ onBack }: ConfigurarFilaProps) {
    ...
    prioridades: [
      {
        ...
        cor: '#EF4444',
        peso: 100,
        descricao: 'Casos de emergência odontológica',
        ativo: true,
      },
      {
        id: 2,
        ...
        cor: '#F59E0B',
        peso: 80,
        descricao: 'Dor intensa que requer atenção rápida',
        ativo: true,
      },
      {
        id: 3,
        ...
        cor: '#F97316',
        peso: 60,
        descricao: 'Casos importantes mas não urgentes',
        ativo: true,
      },
      {
        id: 4,
      ...
      },
      {
        ...
        cor: '#10B981',
        peso: 20,
        descricao: 'Consultas preventivas e orientações',
        ativo: true,
      },
    ],
    tempos: {
  ...
  const handleResetChanges = () => {
    if (
      window.confirm('Tem certeza que deseja desfazer todas as alterações?')
    ) {
                ...
                <div className='flex items-center gap-3'>
                  <div className='flex flex-col items-center gap-1'>
                    ...
                    <Button
                      size='sm'
                      variant='secondary'
                      disabled={index === configuracoes.prioridades.length - 1}
                    >
              ...
              <div className='flex items-start gap-2'>
                ...
                <div>
                  ...
                  <p className='text-sm text-blue-700 mt-1'>
                    O algoritmo híbrido combina o peso da prioridade com o tempo
                    de espera. Quanto maior o fator tempo, mais influência o
                    tempo de espera terá na ordenação da fila.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div>
              ...
              <p className='text-xs text-gray-500 mt-1'>
                Usado para calcular estimativas de tempo
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className='text-xs text-gray-500 mt-1'>
                Alerta será enviado se exceder este tempo
              </p>
            </div>
            ...
            <div>
              ...
              <div className='flex gap-2'>
                <input
                  type='time'
                  value={
                    configuracoes.tempos.horarioFuncionamento.almoco.inicio
                  }
          ...
          <div className='space-y-4'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Ajustar estimativas baseado no histórico real
                </p>
              </div>
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Ajustar tempo baseado na descrição do caso
                </p>
              </div>
              <label className='relative inline-flex items-center cursor-pointer'>
                <input type='checkbox' defaultChecked className='sr-only' />
          ...
          <div className='space-y-4'>
            <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Distribuir pacientes automaticamente entre dentistas
                  disponíveis
                </p>
              </div>
            ...
            <div className='flex items-start gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-yellow-700'>
                  Considere aumentar o intervalo entre consultas de Endodontia
                  para 10 minutos
                </p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700'>
                  Dr. João Silva está com 40% mais consultas que a média.
          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-4'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Status: Operacional • 5 pacientes na fila
                </p>
              </div>
            </div>
            <div className='flex items-center gap-2'>
