...
import { ArrowLeft, Calendar, User, FileText, Download, Star, Eye, MessageSquare, Pill, Camera, Phone, Mail, Share, Printer as Print, Edit, AlertCircle, CheckCircle, Heart, Thermometer } from 'lucide-react'
...
const getConsultaDetalhes = (id: string) => {
  const consultas = {
    'h1': {
      ...
      queixaPrincipal: 'Dor leve no dente molar direito ao mastigar alimentos duros',
      historiaDoenca: 'Paciente relata dor intermitente há aproximadamente 1 semana, sem irradiação, que piora com alimentos gelados.',
      exameClinico: 'Dente 16 com restauração antiga em amálgama apresentando infiltração marginal. Gengivas com leve inflamação generalizada. Demais dentes sem alterações significativas.',
      diagnostico: 'Cárie secundária em dente 16. Gengivite leve generalizada.',
      tratamentoRealizado: 'Remoção da restauração antiga, limpeza da cavidade, aplicação de base protetora e nova restauração em resina composta. Profilaxia e orientações de higiene oral.',
      avaliacao: 5,
      prescricao: true,
      receita: 'Ibuprofeno 600mg - 1 comprimido a cada 8 horas por 3 dias (apenas se houver dor)',
      observacoes: 'Paciente apresentou leve sensibilidade durante o procedimento. Recomendado uso de pasta específica para dentes sensíveis. Retorno em 6 meses para consulta de rotina.',
      ...
      feedback: {
        ...
        ambiente: 5,
        recomendaria: true,
        comentario: 'Excelente atendimento! Dr. João foi muito atencioso e explicou todo o procedimento. Ambiente muito limpo e organizado.'
      }
    }
  }
...
export function DetalhesConsulta({ consultaId, onBack }: DetalhesConsultaProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-primaryDark">Detalhes da Consulta</h1>
            <p className="text-gray-600 mt-1">
              {consulta.data.toLocaleDateString('pt-BR')} • {consulta.especialidade}
            </p>
          </div>
        </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-primaryDark">Consulta Finalizada</h3>
                <p className="text-sm text-gray-600">
                  {consulta.data.toLocaleDateString('pt-BR')} das {consulta.horaInicio} às {consulta.horaFim}
                </p>
              </div>
            </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-medium">
                        {consulta.data.toLocaleDateString('pt-BR')} • {consulta.horaInicio} - {consulta.horaFim}
                      </p>
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 p-3 bg-gray-50 rounded-lg">{consulta.queixaPrincipal}</p>
                  </div>

                  <div>
                    <label className="text-sm font-medium text-gray-600">Descrição Inicial</label>
                    <p className="mt-1 p-3 bg-gray-50 rounded-lg">{consulta.descricaoInicial}</p>
                  </div>
                </CardContent>
              </Card>
                ...
                <Card className="border-accent/20 bg-accent/5">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-accent">Próxima Consulta Agendada</h4>
                        <p className="text-sm text-gray-600">
                          {consulta.proximaConsulta.toLocaleDateString('pt-BR')} - Consulta de retorno
                        </p>
                      </div>
                    </div>
                  </CardContent>
          ...
          {activeTab === 'clinico' && (
            <div className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">{consulta.historiaDoenca}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">{consulta.exameClinico}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                    <p className="text-blue-800 font-medium">{consulta.diagnostico}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">{consulta.tratamentoRealizado}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">{consulta.observacoes}</p>
                </CardContent>
              </Card>
            </div>
          )}
              ...
              <CardContent className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">R$ {consulta.custos.consulta.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Procedimentos:</span>
                      <span className="font-medium">R$ {consulta.custos.procedimentos.toFixed(2)}</span>
                    </div>
                    <hr />
                    <div className="flex justify-between text-lg font-bold">
                      <span>Total:</span>
                      <span className="text-accent">R$ {consulta.custos.total.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">{consulta.custos.formaPagamento}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Parcelamento</label>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-primaryDark">{consulta.avaliacao}/5</p>
                ...
                <div>
                  <label className="text-sm font-medium text-gray-600">Seu Comentário</label>
                  <div className="mt-2 p-4 bg-gray-50 rounded-lg">
                    <p className="text-gray-700">{consulta.feedback.comentario}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 p-4 bg-accent/5 rounded-lg">
                  ...
                  <span className="text-accent font-medium">
                    {consulta.feedback.recomendaria ? 'Você recomendaria este profissional' : 'Você não recomendaria este profissional'}
                  </span>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <div>
                  <h4 className="font-medium text-primaryDark">{consulta.dentista.nome}</h4>
                  <p className="text-sm text-gray-600">{consulta.dentista.cro}</p>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">{consulta.sinaisVitais.pressaoArterial}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Frequência Cardíaca:</span>
                <span className="text-sm font-medium">{consulta.sinaisVitais.frequenciaCardiaca}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Temperatura:</span>
                <span className="text-sm font-medium">{consulta.sinaisVitais.temperatura}</span>
              </div>
            </CardContent>
          </Card>
