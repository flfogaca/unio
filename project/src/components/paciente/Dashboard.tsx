...
export function PacienteDashboard() {
  ...
  const consultaAtiva = minhasConsultas.find(
    item => item.status === 'em-fila' || item.status === 'em-atendimento'
  );
  const historicoConsultas = minhasConsultas.filter(
  ...
  const stats = [
    {
      ...
      icon: Users,
      description: consultaAtiva
        ? 'Consultas à sua frente'
            ...
            {consultaAtiva ? (
                  ...
                  <div className='bg-green-50 border-2 border-green-200 p-4 rounded-lg animate-pulse'>
                    <div className='text-center'>
                      ...
                      <p className='text-green-700 text-sm mb-3'>
                        {consultaAtiva.dentistaNome || 'Profissional'} está te
                        aguardando
                      </p>
                      <Button
              ...
              <div className='text-center py-8'>
                ...
                <p className='text-gray-500 mb-4'>
                  Você não possui consultas ativas
                </p>
              ...
              <div className='space-y-3'>
                ...
                <div className='text-center pt-2'>
                  <Button
                    variant='link'
                    size='sm'
                    onClick={handleNavigateToHistorico}
                  >
