...
export function Suporte({ onBack }: SuporteProps) {
      ...
      questions: [
        {
          ...
          answer: 'Para agendar uma consulta, acesse o menu "Solicitar Atendimento" e preencha o formulário com suas informações. Nossa equipe entrará em contato em até 30 minutos.'
        },
        {
          question: 'Posso cancelar ou remarcar uma consulta?',
          answer: 'Sim! Você pode cancelar ou remarcar até 2 horas antes do horário agendado através do seu dashboard ou entrando em contato conosco.'
        },
        {
          question: 'Como funciona a fila de atendimento?',
          answer: 'Nossa fila é organizada por prioridade médica e ordem de chegada. Casos urgentes têm prioridade e você pode acompanhar sua posição em tempo real.'
        },
        {
          question: 'Quanto tempo demora uma teleconsulta?',
          answer: 'Em média, as consultas duram entre 15 a 30 minutos, dependendo da complexidade do caso e dos procedimentos necessários.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Verifique sua conexão com a internet, permissões do navegador para câmera/microfone e tente atualizar a página. Se persistir, use nosso chat de suporte.'
        },
        {
          question: 'O site não carrega ou está lento',
          answer: 'Limpe o cache do navegador, verifique sua conexão com a internet ou tente acessar em modo anônimo. Recomendamos Chrome ou Firefox atualizados.'
        },
        {
          question: 'Como baixar documentos e receitas?',
          answer: 'Acesse seu histórico de consultas, clique na consulta desejada e use o botão "Baixar" nos documentos disponíveis.'
        },
        {
          question: 'Não consigo fazer login na minha conta',
          answer: 'Verifique se está usando o email correto. Se esqueceu a senha, use "Esqueci minha senha" ou entre em contato conosco.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Aceitamos cartão de crédito, débito, PIX e boleto bancário. Também oferecemos parcelamento em até 12x sem juros.'
        },
        {
          question: 'Como funciona o reembolso?',
          answer: 'Reembolsos são processados em até 7 dias úteis. Entre em contato conosco com o número da consulta para solicitar.'
        },
        {
          question: 'Vocês atendem convênios médicos?',
          answer: 'Atualmente não atendemos convênios, mas fornecemos todos os documentos necessários para reembolso junto ao seu plano de saúde.'
        },
        {
          question: 'Existe desconto para consultas de retorno?',
          answer: 'Sim! Consultas de retorno com o mesmo profissional em até 30 dias têm 50% de desconto.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Para dor intensa: tome analgésico conforme orientação médica, aplique compressa fria e solicite atendimento urgente em nossa plataforma.'
        },
        {
          question: 'Quebrei um dente, o que fazer?',
          answer: 'Guarde os fragmentos em leite ou soro fisiológico, evite mastigar do lado afetado e procure atendimento imediatamente.'
        },
        {
          question: 'Sangramento na gengiva não para',
          answer: 'Faça pressão suave com gaze limpa, evite bochechos vigorosos e procure atendimento se não melhorar em 30 minutos.'
        },
        {
          question: 'Inchaço no rosto após procedimento',
          answer: 'Aplique gelo por 15 minutos a cada hora nas primeiras 24h. Se piorar ou houver febre, procure atendimento imediato.'
        }
      ]
    }
  ]
  ...
  const renderInicio = () => (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <h3 className="font-semibold text-primaryDark mb-1">Disponibilidade</h3>
      ...
      {/* Contact Options */}
      <div>
        <h2 className="text-2xl font-bold text-primaryDark mb-6">Como podemos ajudar?</h2>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-primaryDark">{option.title}</h3>
                      <p className="text-sm text-gray-600 mb-1">{option.description}</p>
                      <div className="flex items-center gap-2">
                        <Clock className="h-3 w-3 text-gray-400" />
                        <span className={`text-xs ${option.available ? 'text-accent' : 'text-gray-400'}`}>
                          {option.time}
                        </span>
                      </div>
                    </div>
                    {option.available && <ChevronRight className="h-5 w-5 text-gray-400" />}
                  </div>
                </CardContent>
              </Card>
            )
      ...
      {/* Quick Actions */}
      <div>
        <h2 className="text-2xl font-bold text-primaryDark mb-6">Ações Rápidas</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {quickActions.map((action, index) => {
            const Icon = action.icon
            return (
              <Card key={index} className="cursor-pointer hover:shadow-lg transition-all hover:scale-105" onClick={action.action}>
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-medium text-primaryDark">{action.title}</h3>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-primaryDark">Perguntas Frequentes</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {faqCategories.slice(0, 4).map((category) => {
            ...
            return (
              <Card key={category.id} className="cursor-pointer hover:shadow-lg transition-all" onClick={() => {
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-medium text-primaryDark">{category.title}</h3>
                  </div>
      ...
      {/* Resources */}
      <div>
        <h2 className="text-2xl font-bold text-primaryDark mb-6">Recursos Úteis</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card key={index} className="cursor-pointer hover:shadow-lg transition-all">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <h3 className="font-medium text-primaryDark mb-1">{resource.title}</h3>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-primaryDark text-sm">{category.title}</h3>
                  <p className="text-xs text-gray-500">{category.questions.length} perguntas</p>
                </div>
              </div>
            </button>
          )
            ...
            <div key={category.id}>
              ...
              <div className="space-y-3">
                {category.questions.map((faq, index) => (
                  <Card key={index}>
                    <CardContent className="p-6">
                      <h4 className="font-medium text-primaryDark mb-2">{faq.question}</h4>
      ...
      {filteredFAQ.length === 0 && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-500 mb-2">Nenhuma pergunta encontrada</h3>
            <p className="text-gray-400 mb-6">Tente usar termos diferentes ou entre em contato conosco</p>
  ...
  const renderChat = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-primaryDark">Chat com Suporte</h2>
        <Button variant="secondary" onClick={() => setActiveSection('inicio')}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Voltar
        </Button>
              ...
              <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                <div className="flex gap-3">
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 max-w-xs">
                    <p className="text-sm">Olá! Sou a Ana do suporte Unio. Como posso ajudá-lo hoje?</p>
