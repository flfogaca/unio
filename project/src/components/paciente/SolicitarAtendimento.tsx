...
const especialidades = ['Dentista', 'Psicólogo', 'Médico Clínico'];

const prioridades = [
  {
    value: 'baixa',
    label: 'Baixa - Consulta de rotina',
    description: 'Sem dor ou desconforto',
  },
  {
    value: 'media',
    label: 'Média - Desconforto moderado',
    description: 'Algum incômodo, mas suportável',
  },
  {
    value: 'alta',
    label: 'Alta - Dor intensa',
    description: 'Dor forte que precisa de atenção urgente',
  },
];
...
export function SolicitarAtendimento() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const message =
        error?.message || 'Erro ao solicitar atendimento. Tente novamente.';
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1:
        return formData.especialidade && formData.prioridade;
      case 2:
        return formData.descricao.trim().length > 10;
      case 3:
      ...
      <div className='max-w-2xl mx-auto'>
        <Card>
          <CardContent className='p-8 text-center'>
            ...
            <h2 className='text-2xl font-bold text-primaryDark mb-2'>
              Solicitação Enviada!
            </h2>
            <p className='text-gray-600 mb-6'>
              Sua consulta foi adicionada à fila. Você receberá uma notificação
              quando for sua vez.
            </p>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                  {especialidades.map(esp => (
                    <button
                      key={esp}
                      onClick={() =>
                        setFormData(prev => ({ ...prev, especialidade: esp }))
                      }
            ...
            <div className='space-y-6'>
              <div>
                ...
                <p className='text-sm text-gray-500 mb-4'>
                  Uma imagem pode ajudar o dentista a fazer um diagnóstico mais
                  preciso
                </p>
              ...
              <div className='bg-yellow-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-yellow-700'>
                  Não compartilhe informações pessoais sensíveis ou documentos
                  de identidade. Apenas imagens relacionadas ao problema
                  odontológico.
                </p>
              </div>
            </div>
