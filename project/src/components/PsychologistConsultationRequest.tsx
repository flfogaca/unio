...
const urgencyLevels = [
  { value: 'low', label: 'Baixa', color: 'bg-green-100 text-green-800', description: 'Consulta de rotina' },
  { value: 'medium', label: 'Média', color: 'bg-yellow-100 text-yellow-800', description: 'Necessita atendimento em breve' },
  { value: 'high', label: 'Alta', color: 'bg-orange-100 text-orange-800', description: 'Situação preocupante' },
  { value: 'crisis', label: 'Crise', color: 'bg-red-100 text-red-800', description: 'Atendimento imediato necessário' },
];

const commonSymptoms = [
  'Ansiedade', 'Depressão', 'Estresse', 'Insônia', 'Pânico',
  'Irritabilidade', 'Tristeza', 'Medo', 'Angústia', 'Dificuldade de concentração',
  'Mudanças de humor', 'Perda de interesse', 'Fadiga', 'Preocupação excessiva'
];

const commonMedications = [
  'Fluoxetina', 'Sertralina', 'Escitalopram', 'Citalopram', 'Paroxetina',
  'Venlafaxina', 'Duloxetina', 'Bupropiona', 'Mirtazapina', 'Clonazepam',
  'Alprazolam', 'Lorazepam', 'Diazepam', 'Outros'
];

export const PsychologistConsultationRequest: React.FC<PsychologistConsultationRequestProps> = ({
  onRequestSubmitted
}) => {
  const [consultationType, setConsultationType] = useState<'urgent' | 'scheduled'>('urgent');
  const [urgencyLevel, setUrgencyLevel] = useState<'low' | 'medium' | 'high' | 'crisis'>('medium');
  ...
  const handleSubmit = async () => {
    ...
    try {
      const request = {
        ...
        reason: reason.trim(),
        urgencyLevel,
        preferredTime: consultationType === 'scheduled' ? preferredTime : undefined,
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Solicitar Consulta com Psicólogo</h2>
            <p className="text-sm text-gray-500">
              Descreva sua situação para que possamos conectá-lo com o profissional mais adequado
            </p>
          </div>
        </div>
        ...
        {isCrisisLevel && (
          <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-red-800 mb-1">Situação de Crise Detectada</h3>
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Atendimento imediato</div>
                  </div>
                </div>
              </button>
          ...
          <Card className="p-6">
            ...
            {selectedSymptoms.length > 0 && (
              <div className="mt-4">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Sintomas Selecionados:</h4>
          ...
          {/* Medication */}
          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-4">Medicamentos Atuais (opcional)</h3>
            <p className="text-sm text-gray-600 mb-4">
            ...
            {currentMedication.length > 0 && (
              <div className="mt-4">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Medicamentos Selecionados:</h4>
                <div className="flex flex-wrap gap-2">
          ...
          {/* Previous Therapy */}
          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-4">Histórico Terapêutico</h3>
            <div className="flex items-center gap-3">
              <input
                type="checkbox"
                id="previousTherapy"
              ...
              />
              <label htmlFor="previousTherapy" className="text-sm text-gray-700">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-red-50 rounded-lg">
                <div className="font-medium text-red-800">CVV - Centro de Valorização da Vida</div>
                <div className="text-lg font-bold text-red-600">188</div>
                <div className="text-xs text-red-600">24 horas - Suporte emocional</div>
              </div>
              ...
              <div className="p-3 bg-green-50 rounded-lg">
                ...
                <div className="text-xs text-green-600">Violência doméstica</div>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            >
              ...
              {isCrisisLevel ? 'Solicitar Atendimento de Crise' : 'Solicitar Consulta'}
            </Button>
