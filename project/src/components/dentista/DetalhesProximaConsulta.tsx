...
export function DetalhesProximaConsulta({
  consulta,
  onClose,
  onAssumeConsulta,
}: DetalhesProximaConsultaProps) {
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div>
                    ...
                    <p className='font-medium'>
                      {detalhes.pacienteInfo.idade} anos
                    </p>
                  </div>
                  <div>
                    <label className='text-sm font-medium text-gray-600'>
                  ...
                  <div>
                    ...
                    <p className='font-medium'>
                      {detalhes.pacienteInfo.profissao}
                    </p>
                  </div>
                </div>
              ...
              <CardContent className='space-y-3'>
                <div className='flex items-center gap-3'>
                  ...
                  <span className='text-sm'>
                    {detalhes.pacienteInfo.telefone}
                  </span>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
                  <div className='text-center p-3 bg-gray-50 rounded-lg'>
                    ...
                    <p className='font-semibold text-primaryDark'>
                      {detalhes.sinaisVitais.pressaoArterial}
                    </p>
                  </div>
                  <div className='text-center p-3 bg-gray-50 rounded-lg'>
                    <p className='text-sm text-gray-600'>Freq. Cardíaca</p>
                    <p className='font-semibold text-primaryDark'>
                      {detalhes.sinaisVitais.frequenciaCardiaca}
                    </p>
                  </div>
                  <div className='text-center p-3 bg-gray-50 rounded-lg'>
                    <p className='text-sm text-gray-600'>Temperatura</p>
                    <p className='font-semibold text-primaryDark'>
                      {detalhes.sinaisVitais.temperatura}
                    </p>
                  </div>
                  <div className='text-center p-3 bg-gray-50 rounded-lg'>
                    <p className='text-sm text-gray-600'>Peso</p>
                    <p className='font-semibold text-primaryDark'>
                      {detalhes.sinaisVitais.peso}
                    </p>
                  </div>
                  <div className='text-center p-3 bg-gray-50 rounded-lg'>
                    <p className='text-sm text-gray-600'>Altura</p>
                    <p className='font-semibold text-primaryDark'>
                      {detalhes.sinaisVitais.altura}
                    </p>
                  </div>
                  <div className='text-center p-3 bg-gray-50 rounded-lg'>
              ...
              <CardContent>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <p className='text-sm'>
                      {detalhes.preferencias.horarioPreferido}
                    </p>
                  </div>
                  <div>
                    <label className='text-sm font-medium text-gray-600'>
                    ...
                    <p className='text-sm'>
                      {detalhes.preferencias.comunicacao}
                    </p>
                  </div>
                  <div>
                    <label className='text-sm font-medium text-gray-600'>
                  ...
                  <div>
                    ...
                    <p className='text-sm'>
                      {detalhes.preferencias.necessidadesEspeciais}
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className='flex items-center justify-between mb-4'>
                  <div>
                    ...
                    <p className='text-2xl font-bold text-primaryDark'>
                      {detalhes.historicoMedico.totalConsultas}
                    </p>
                  </div>
                  <div>
                    <p className='text-sm text-gray-600'>Última consulta</p>
                    <p className='font-medium'>
                      {detalhes.historicoMedico.ultimaConsulta.toLocaleDateString(
                        'pt-BR'
                      )}
                    </p>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                {detalhes.historicoMedico.medicamentosUso.length > 0 ? (
                  <div className='space-y-2'>
                    {detalhes.historicoMedico.medicamentosUso.map(
                      (medicamento, index) => (
                        <div
                          key={index}
              ...
              <CardContent>
                <div className='space-y-3'>
                  <div>
                    ...
                    <div className='mt-1'>
                      {detalhes.historicoMedico.condicoesMedicas.map(
                        (condicao, index) => (
                          <span
                            key={index}
                  ...
                  <div>
                    ...
                    <div className='mt-1'>
                      {detalhes.historicoMedico.cirurgiasAnteriores.map(
                        (cirurgia, index) => (
                          <span
                            key={index}
              ...
              <CardContent>
                <div className='space-y-4'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${
                        detalhes.avaliacaoRisco.nivel === 'alto'
                          ? 'bg-red-100 text-red-800'
                          : detalhes.avaliacaoRisco.nivel === 'médio'
                            ? 'bg-yellow-100 text-yellow-800'
                            : 'bg-green-100 text-green-800'
                      }`}
                    >
                      {detalhes.avaliacaoRisco.nivel.charAt(0).toUpperCase() +
                        detalhes.avaliacaoRisco.nivel.slice(1)}
                    </span>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className='mt-1 text-sm text-gray-700'>
                      {detalhes.avaliacaoRisco.recomendacoes.map(
                        (recomendacao, index) => (
                          <li key={index} className='flex items-center gap-2'>
          ...
          <div className='space-y-6'>
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <p className='mt-1 p-3 bg-gray-50 rounded-lg'>
                      {detalhes.consultaAtual.motivoConsulta}
                    </p>
                  </div>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div>
                      ...
                      <p className='font-medium'>
                        {detalhes.consultaAtual.duracaoSintomas}
                      </p>
                    </div>
                    <div>
                      <label className='text-sm font-medium text-gray-600'>
                      ...
                      <div className='flex items-center gap-2'>
                        <span className='font-bold text-lg text-red-600'>
                          {detalhes.consultaAtual.intensidadeDor}
                        </span>
                        <div className='flex-1 bg-gray-200 rounded-full h-2'>
                          <div
                            className='bg-red-500 h-2 rounded-full'
                            style={{
                              width: `${(detalhes.consultaAtual.intensidadeDor / 10) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <Card>
                ...
                <CardContent>
                  <p className='text-sm text-gray-700'>
                    {detalhes.consultaAtual.fatoresAgravantes}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className='text-sm text-gray-700'>
                    {detalhes.consultaAtual.fatoresAliviantes}
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-sm text-gray-700'>
                  {detalhes.consultaAtual.expectativas}
                </p>
              </CardContent>
            </Card>
                    ...
                    <div className='mt-1'>
                      <span
                        className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${
                          consulta.prioridade === 'alta'
                            ? 'bg-red-100 text-red-800'
                            : consulta.prioridade === 'media'
                              ? 'bg-yellow-100 text-yellow-800'
                              : 'bg-green-100 text-green-800'
                        }`}
                      >
                        {consulta.prioridade.charAt(0).toUpperCase() +
                          consulta.prioridade.slice(1)}
                      </span>
                    </div>
                  </div>
                  <div>
          ...
          <div className='flex items-center gap-4'>
            ...
            <div>
              <h2 className='text-xl font-bold'>
                {detalhes.pacienteInfo.nome}
              </h2>
              <p className='text-sm opacity-90'>
                {consulta.especialidade} • Próxima consulta
              </p>
            </div>
          </div>
          <div className='flex items-center gap-3'>
