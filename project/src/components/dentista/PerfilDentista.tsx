...
export function PerfilDentista() {
  ...
  const [formData, setFormData] = useState({
    ...
    biografia:
      'Dentista especializado em clínica geral e endodontia com mais de 10 anos de experiência. Formado pela USP, pós-graduado em Endodontia pela UNICAMP.',
    formacao: [
      {
    ...
    certificacoes: [
      {
        nome: 'Certificação em Implantodontia',
        instituicao: 'ABO-SP',
        ano: '2019',
      },
      {
        nome: 'Curso Avançado de Endodontia',
        instituicao: 'APCD',
        ano: '2020',
      },
    ],
                ...
                <div>
                  ...
                  <div className='flex items-center gap-2 mt-1'>
                    ...
                    <span className='text-sm text-gray-500'>
                      ({estatisticas.consultasRealizadas} consultas)
                    </span>
                  </div>
                </div>
                <Button
            ...
            <div className='flex items-start gap-2'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700 mt-1'>
                  Os horários definidos aqui serão usados para calcular sua
                  disponibilidade na fila de atendimento. Você pode ajustar
                  conforme sua agenda pessoal.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-2xl font-bold text-primaryDark'>
                  {estatisticas.consultasRealizadas}
                </p>
              ...
              <div>
                ...
                <div className='flex items-center gap-1'>
                  {Array.from({ length: 5 }, (_, i) => (
                    <Star
                      key={i}
                      className={`h-3 w-3 ${i < Math.floor(estatisticas.avaliacaoMedia) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`}
                    />
                  ))}
                </div>
              </div>
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-2xl font-bold text-primaryDark'>
                  {estatisticas.pacientesAtendidos}
                </p>
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-2xl font-bold text-primaryDark'>
                  {estatisticas.tempoMedioConsulta}min
                </p>
                  ...
                  <div className='flex items-center justify-between mb-1'>
                    ...
                    <div className='flex gap-1'>
                      {Array.from({ length: 5 }, (_, i) => (
                        <Star
                          key={i}
                          className={`h-3 w-3 ${i < item.avaliacao ? 'text-yellow-400 fill-current' : 'text-gray-300'}`}
                        />
                      ))}
                    </div>
                  </div>
        ...
        <CardContent className='space-y-4'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Receber notificações sobre consultas e mensagens
              </p>
            </div>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Receber SMS para consultas urgentes
              </p>
            </div>
            <label className='relative inline-flex items-center cursor-pointer'>
              <input
        ...
        <CardContent className='space-y-4'>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Permitir que pacientes vejam seu perfil
              </p>
            </div>
            <label className='relative inline-flex items-center cursor-pointer'>
              <input
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Exibir estatísticas no perfil público
              </p>
            </div>
            <label className='relative inline-flex items-center cursor-pointer'>
              <input
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                Pacientes podem avaliar suas consultas
              </p>
            </div>
            <label className='relative inline-flex items-center cursor-pointer'>
              <input
