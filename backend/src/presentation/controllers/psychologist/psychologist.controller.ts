...
export class PsychologistController {
  ...
  @ApiOperation({
    summary: 'Request psychologist consultation (Patients only)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    summary: 'Create psychological assessment (Psychologists only)',
  })
  ...
  @RequireSpecialty(Specialty.psicologo, [UserRole.psicologo, UserRole.admin])
  @ApiOperation({
    summary: 'Create therapy session record (Psychologists only)',
  })
  ...
  async getCrisisAlerts(@CurrentUser() user: any) {
    const dashboard = await this.psychologistService.getPsychologistDashboard(
      user.id
    );
  ...
  @ApiResponse({
    status: 200,
    description: 'Urgent queue retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Today's sessions retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'My consultations retrieved successfully',
  })
