...
export class ConsultationsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Professional queue retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Consultation assumed successfully',
  })
  @ApiResponse({ status: 404, description: 'Consultation not found' })
  ...
  async assume(@Param('id') id: string, @CurrentUser() user: any) {
    ...
    const userSpecialty = this.specialtyFilterService.getUserSpecialty(
      user.role
    );
