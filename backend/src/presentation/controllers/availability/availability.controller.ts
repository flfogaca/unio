...
export class AvailabilityController {
  ...
  @ApiResponse({
    status: 200,
    description: 'All specialties availability retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Professional availability retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Professional availability updated successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: '24/7 availability updated successfully',
  })
  async setSpecialty24hAvailability(
    ...
    return this.availabilityService.setSpecialty24hAvailability(
      specialty,
      body.enabled
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Next available time calculated successfully',
  })
  async getNextAvailableTime(
    ...
    const nextAvailable =
      await this.availabilityService.getNextAvailableTime(specialty);
    return {
      specialty,
